  ...
  return (
    <div className="">
      ...
      <div className="container mt-4">
        <div className="row">
          <div className="col-4 shadow me-auto ms-5">
            <h4 className="mt-3">
              Why Host on <span className="text-danger">HorseBnB</span>
            </h4>
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero
              maiores aut laudantium sapiente numquam perspiciatis, vero
              recusandae. Doloremque, distinctio blanditiis!
            </p>
          </div>
          <div className="col-4 shadow ms-auto me-5">
            <h4 className="mt-3">
              We have your<span className="text-danger">Back</span>
            </h4>
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero
              maiores aut laudantium sapiente numquam perspiciatis, vero
        ...
        <div className="row mt-5 text-center">
          ...
          <div className="col-3 shadow m-auto">
            <img src={checkcircle} alt="" />
            <p className="mt-2">
              <b>Decide how you want to host </b>
            </p>
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero
              maiores aut laudantium sapiente numquam perspiciatis, vero
      ...
      <div className="container-fluid bg-danger mt-5">
        <div className="row">
          <div className="col-5 mb-3 me-auto ms-5">
            <img
              alt=""
      ...
      <div className="container">
        <div className="row mb-5 mt-5">
          <div className="col-4 me-auto ms-5 border border-2 p-3">
            <p>
              <b>What is HorseBnB</b>
            </p>
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed
              expedita at dicta quae quidem perspiciatis.
            </p>
          </div>
